...
const SearchBar = ({ query, onChange, onSubmit, onOpenFilter, isFixed = false }: SearchBarProps) => {
  if (isFixed) {
    return (
      <div className="absolute bottom-5 left-0 right-0 mx-auto w-full max-w-[1100px] px-4 sm:px-6 <div className="absolute bottom-5 left-0 right-0 mx-auto w-full max-w-[1100px] px-4 sm:px-6 z-30 animate-fade-in">">
